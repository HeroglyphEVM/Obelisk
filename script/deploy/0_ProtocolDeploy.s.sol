...
contract ProtocolDeploy is BaseScript {
  ...
  function run() external override {
    ...
    vm.startBroadcast(_getDeployerPrivateKey());
    ObeliskRegistry(payable(obeliskRegistry)).allowNewCollection(
      0x942BC2d3e7a589FE5bd4A5C6eF9727DFd82F5C8a, 0, 1_667_308_800, false
    );
    ObeliskRegistry(payable(obeliskRegistry)).forceActiveCollection(
      0x942BC2d3e7a589FE5bd4A5C6eF9727DFd82F5C8a
    );

    ObeliskRegistry(payable(obeliskRegistry)).allowNewCollection(
      0x026224A2940bFE258D0dbE947919B62fE321F042, 0, 1_628_707_200, false
    );
    ObeliskRegistry(payable(obeliskRegistry)).forceActiveCollection(
    ...
    ObeliskRegistry(payable(obeliskRegistry)).allowNewCollection(
      0x524cAB2ec69124574082676e6F654a18df49A048, 0, 1_639_919_345, false
    );
    ObeliskRegistry(payable(obeliskRegistry)).forceActiveCollection(
    ...
    ObeliskRegistry(payable(obeliskRegistry)).allowNewCollection(
      0xc3f733ca98E0daD0386979Eb96fb1722A1A05E69, 0, 1_565_350_566, false
    );
    ObeliskRegistry(payable(obeliskRegistry)).forceActiveCollection(
    ...
    ObeliskRegistry(payable(obeliskRegistry)).allowNewCollection(
      0x07887Ee0Bd24E774903963d50cF4Ec6a0a16977D, 0, 1_643_124_319, false
    );
    ObeliskRegistry(payable(obeliskRegistry)).forceActiveCollection(
